        ...
        for obj, properties in scene.items():
            ...
            for prop in properties:
                if isinstance(prop, RgbColorPerception):
                    viz.add_model(sc.cross_section_to_geo(obj.geon.cross_section),
                          SceneCreator.random_position(), prop)
                    obj_added = True
            if not obj_added:
                viz.add_model(sc.cross_section_to_geo(obj.geon.cross_section),
                ...
                for frame in perception.frames:  # DevelopmentalPrimitivePerceptionFrame
                    ...
                    for property in frame.property_assertions:
                        if hasattr(property, "color"):
                            ...
                            property_map[property.perceived_object].append(property.binary_property)
                print(property_map)
