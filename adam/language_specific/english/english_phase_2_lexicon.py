...
from adam.ontology.phase2_ontology import GAILA_PHASE_2_ONTOLOGY, CHAIR_5, CUP_2, CUP_3, CUP_4, CHAIR_2, CHAIR_3, \
    CHAIR_4

GAILA_PHASE_2_ENGLISH_LEXICON = OntologyLexicon(
    ontology=GAILA_PHASE_2_ONTOLOGY,
    ontology_node_to_word=[word for word in GAILA_PHASE_1_ENGLISH_LEXICON._ontology_node_to_word.items()] + [
