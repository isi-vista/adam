...
classdef UGraph < BetterHandle
    ...
    properties
        ...
        P  % [nimg x nimg boolean] binarize original image
    end
    ...
    methods
        ...
        function this = UGraph(G,E,EI,S,I,P)
           this.G = G;
           this.E = E;
           this.EI = EI;
           this.S = S; 
...
%             imshow(I);
            ...
            for i=1:this.n
               plot(this.G(i,2),this.G(i,1),'r.','MarkerSize',30); 
            end
...
function plot_traj(stk,color)
    ...
    stk(:,2) = stk(:,1);
    stk(:,1) = ystk;       
    plot(stk(:,1),stk(:,2),'Color',color,'LineWidth',3);
end